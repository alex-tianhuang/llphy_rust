...
use llphyscore_core::datatypes::{FastaEntry, PostProcessedFeatureMatrix};

/// Output the final biophysical scores (currently
/// [`PostProcessedFeatureMatrix`]) associated with the given
/// `sequences` to a file at the given `path` or stdout.
pub fn write_output(
    path: Option<PathBuf>,
...
/// Helper method for [`write_output`] that doesn't depend
